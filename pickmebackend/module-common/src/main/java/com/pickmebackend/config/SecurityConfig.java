...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().mvcMatchers("/docs/index.html", "/api/images/**");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                    .antMatchers(HttpMethod.GET, "/api", "/api/accounts/", "/api/accounts", "/api/enterprises", "/api/enterprises/", "/api/accounts/**/favorite", "/api/technologies", "/api/enterprises/filter", "/api/enterprises/**").permitAll()
                    .antMatchers(HttpMethod.POST, "/api/accounts/", "/api/enterprises", "/api/accounts", "/api/enterprises/", "/api/login", "/api/accounts/sendCode").permitAll()
                    .antMatchers(HttpMethod.PUT, "/api/accounts/matchCode").permitAll()
                    ...
                    .antMatchers(HttpMethod.POST, "/api/enterprises/**").hasRole("ENTERPRISE")
