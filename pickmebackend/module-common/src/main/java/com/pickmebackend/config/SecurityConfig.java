...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                    .antMatchers(HttpMethod.GET, "/api", "/api/accounts/", "/api/accounts", "/api/enterprises", "/api/enterprises/", "/api/accounts/**/favorite", "/api/technologies", "/api/enterprises/**").permitAll()
